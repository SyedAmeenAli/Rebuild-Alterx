...
- Name: correction-04.spec.ts >> Correction 04: Hero and Atlas Audit >> Product Atlas regions contain titles and descriptions
- Location: e2e\correction-04.spec.ts:73:7
...
Locator:  locator('button.bg-\\[\\#fbfaf7\\], button.bg-\\[\\#111111\\], button.bg-\\[\\#f1eee7\\], button.bg-\\[\\#f15a24\\]').filter({ hasNot: locator('div:has-text("From one objective to")') })
Expected: 4
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('button.bg-\\[\\#fbfaf7\\], button.bg-\\[\\#111111\\], button.bg-\\[\\#f1eee7\\], button.bg-\\[\\#f15a24\\]').filter({ hasNot: locator('div:has-text("From one objective to")') })
...
- generic [active] [ref=e1]:
  - main [ref=e2]:
    ...
    - generic [ref=e22]:
      ...
      - generic [ref=e24]:
        - heading "Start with the outcome. Watch it become work in motion." [level=1] [ref=e25]:
          - generic [ref=e26]: Start with the outcome.
          - generic [ref=e27]:
            - generic [ref=e28]: Watch it become
            - generic: work in motion.
        - generic:
