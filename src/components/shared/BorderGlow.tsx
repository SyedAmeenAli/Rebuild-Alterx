...
function parseHSL(hslStr: string) {
  ...
  if (!match) return { h: 152, s: 70, l: 75 };
...
/**
 * ALTERX mint edge-glow: default colors/glowColor are the brand mint
 * family only (no purple/pink/blue mesh) — pass `colors`/`glowColor`
 * to override, but the ALTERX default stays mint everywhere it's used.
 */
export default function BorderGlow({
  ...
  edgeSensitivity = 26,
  glowColor = "152 70 75",
  backgroundColor = "rgba(6,17,11,0.72)",
  borderRadius = 12,
  glowRadius = 28,
  glowIntensity = 0.6,
  coneSpread = 24,
